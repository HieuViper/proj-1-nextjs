...
const ProductCatForm = (props) => {
    const { handleModal, dataCate, langTable, lang, categories, setCategories } = props
    ...
    useEffect(() => {
        // if (dataCate) {
        //     let productData = (dataCate);
        //     let content = {};

        //     langTable?.forEach((lang) => {
        //         content[`name_${lang.code}`] = getNewsValue('name', productData, lang.code);
        //         content[`description_${lang.code}`] = getNewsValue('description', productData, lang.code);
        //     })
        //     let data1 = { ...productData[0], ...content };
