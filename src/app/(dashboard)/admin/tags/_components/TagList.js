        ...
        <>
            ...
            <Row type="flex" justify="center" >
                <Col xs={24} md={10} lg={8} type="flex" justify="center" align="middle" >
                    <TagForm langTable={langTable}   {...{ addTag, lang, getAllTags, tags, setTags }} />
                </Col>
                <Col xs={24} md={14} lg={14} className="pb-4">
                    ...
                    <Table rowSelection={rowSelection} columns={columns} dataSource={tags} rowKey="id"
                        scroll={{
                            x: 700,
                        }}
                        key={tags?.length}
            ...
            {/* Modal */}
            <Modal title="Edit Tag" open={isModalOpen}
                ...
                <TagForm handleModal={handleOk}
                    dataTag={dataTag}
                    langTable={langTable}
                    {...{ getTag, addTag, editTag, delTag, lang, getAllTags, tags, setTags }}
                />
            </Modal>
        </>
    );
