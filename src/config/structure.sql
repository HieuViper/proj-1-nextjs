...
CREATE TABLE `article_cate_langs` (
  ...
  `article_categoryId` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `article_cate_langs` (`name`, `description`, `article_categoryId`, `languageCode`) VALUES
...
CREATE TABLE `news_cate_langs` (
  `name` varchar(200) DEFAULT 'undefined',
  `description` longtext DEFAULT NULL COMMENT 'Description',
  `news_categoryId` bigint(20) UNSIGNED NOT NULL,
  `languageCode` varchar(10) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `news_cate_langs` (`name`, `description`, `news_categoryId`, `languageCode`) VALUES
...
ALTER TABLE `article_cate_langs`
  ADD PRIMARY KEY (`article_categoryId`,`languageCode`),
  ADD UNIQUE KEY `article_cate_langs_languageCode_article_categoryId_unique` (`article_categoryId`,`languageCode`),
...
ALTER TABLE `news_cate_langs`
  ADD PRIMARY KEY (`news_categoryId`,`languageCode`),
  ADD UNIQUE KEY `news_cate_langs_languageCode_news_categoryId_unique` (`news_categoryId`,`languageCode`),
  ADD KEY `languageCode` (`languageCode`);
...
--
ALTER TABLE `article_cate_langs`
  ADD CONSTRAINT `article_cate_langs_ibfk_1` FOREIGN KEY (`article_categoryId`) REFERENCES `article_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `news_cate_langs`
  ADD CONSTRAINT `news_cate_langs_ibfk_1` FOREIGN KEY (`news_categoryId`) REFERENCES `news_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
